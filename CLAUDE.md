...
**Paths are device-local.** Read `Home_Lab_2026/.env` for the actual paths on this machine. The `.env` file defines: `MLOS_ROOT`, `OPENCLAW_DIR`, `VAULT_DIR`, `CLAUDETEST_DIR`. To find it from this repo, look for the sibling `Home_Lab_2026` directory (same parent as this repo).

| Workspace | Env Var | What Lives There |
|-----------|---------|-----------------|
...
- **Vault context packs:** `$VAULT_DIR/mlos-dev/` (project-state.md, decisions.md, tasks.json, pickup.md)
